    ...
    return WillPopScope(
      ...
      child: Obx((){
        return AnimatedContainer(
            width: !controller.isFFmpegLoaded.value ? 120 : controller.progress.value < 1.0 ? 500 : MediaQuery.of(context).size.width/1.2,
            height: !controller.isFFmpegLoaded.value ? 120 : controller.progress.value < 1.0 ? 120 : 600,
            duration: const Duration(milliseconds: 600),
            child: !controller.isFFmpegLoaded.value ? const Column(
